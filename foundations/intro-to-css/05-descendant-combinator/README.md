...
The goal of this exercise is to apply styles to elements that are descendants of another element, while leaving elements tha *aren't* descendants of that element unstyled.
